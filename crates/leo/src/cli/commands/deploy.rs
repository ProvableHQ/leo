...
pub(crate) fn deploy_with_placeholder_certificate<N: Network, A: Aleo<Network = N>, R: Rng + CryptoRng>(
    ...
    // V14+ requires verifying_keys.len() == num_functions + num_records.
    ...
    for function_name in program.functions().keys() {
        ...
        let verifying_key = VerifyingKey::from_str(
            "",
        )?;
    ...
    // Add placeholder translation verifying keys for each record type.
    // V14+ requires verifying_keys.len() == num_functions + num_records.
...
pub(crate) fn calculate_function_costs<N: Network, R: Rng + CryptoRng>(
    ...
    for (function_name, _) in deployment.verifying_keys() {
        // Skip record translation keys; only actual functions have costs.
        if !deployment.program().functions().contains_key(function_name) {
            continue;
        }
