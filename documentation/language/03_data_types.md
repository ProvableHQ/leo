...
```leo file=../code_snippets/data_types/src/main.leo#addresses
```
...
```leo file=../code_snippets/data_types/src/main.leo#booleans
```
...
```leo file=../code_snippets/data_types/src/main.leo#int_basic
```

Underscores `_` can be used to separate digits in integer literals.

```leo file=../code_snippets/data_types/src/main.leo#int_underscore
```
...
```leo file=../code_snippets/data_types/src/main.leo#int_cast
```
...
```leo file=../code_snippets/data_types/src/main.leo#field_literals
```
...
```leo file=../code_snippets/data_types/src/main.leo#group_literals
```

The aforementioned generator point can be obtained via a constant associated to the `group` type.

```leo file=../code_snippets/data_types/src/main.leo#group_gen
```
...
```leo file=../code_snippets/data_types/src/main.leo#scalar_literals
```
...
```leo file=../code_snippets/data_types/src/main.leo#signature_literal
```
...
```leo file=../code_snippets/data_types/src/main.leo#identifier_literal
```
...
```leo file=../code_snippets/data_types/src/main.leo#arrays_basic
```
...
```leo file=../code_snippets/data_types/src/main.leo#array_access_fn
```
...
```leo file=../code_snippets/data_types/src/main.leo#tuple_basic
```
...
```leo file=../code_snippets/data_types/src/main.leo#tuple_access_fn
```
...
```leo file=../code_snippets/data_types/src/main.leo#option_basic
```
...
```leo file=../code_snippets/data_types/src/main.leo#option_unwrap
```
...
```leo file=../code_snippets/data_types/src/main.leo#type_inference
```
