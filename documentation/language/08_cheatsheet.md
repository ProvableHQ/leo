...
```leo file=../code_snippets/cheatsheet.leo#primitives
```

### Type Casting

```leo file=../code_snippets/cheatsheet.leo#type_casting
```
...
```leo file=../code_snippets/cheatsheet.leo#option_primitives
```
...
```leo file=../code_snippets/cheatsheet.leo#record_definition
```

Creating a `record`:

```leo file=../code_snippets/cheatsheet.leo#record_creation
```

Accessing `record` fields:

```leo file=../code_snippets/cheatsheet.leo#record_access
```
...
```leo file=../code_snippets/cheatsheet.leo#struct_definition
```

Creating an instance of a `struct`:

```leo file=../code_snippets/cheatsheet.leo#struct_creation
```

Accessing `struct` Fields:

```leo file=../code_snippets/cheatsheet.leo#struct_access
```
...
```leo file=../code_snippets/cheatsheet.leo#const_generics_struct
```
...
```leo file=../code_snippets/cheatsheet.leo#option_struct
```
...
```leo file=../code_snippets/cheatsheet.leo#array_decl
```

Accessing elements:

```leo file=../code_snippets/cheatsheet.leo#array_access
```

Looping over arrays:

```leo file=../code_snippets/cheatsheet.leo#array_loop
```
...
```leo file=../code_snippets/cheatsheet.leo#tuple_decl
```

Accessing tuple elements:

```leo file=../code_snippets/cheatsheet.leo#tuple_access
```
...
```leo file=../code_snippets/cheatsheet.leo#helper_fn
```

#### Const Generics

```leo file=../code_snippets/cheatsheet.leo#const_generics_fn
```
...
```leo file=../code_snippets/cheatsheet.leo#entry_calls_helper
```
...
```leo file=../code_snippets/cheatsheet.leo#mint_with_final
```
...
```leo file=../code_snippets/cheatsheet.leo#final_fn_def
```
...
```leo file=../code_snippets/cheatsheet.leo#loops
```

## 10. Conditionals

```leo file=../code_snippets/cheatsheet.leo#conditionals
```
...
```leo file=../code_snippets/cheatsheet.leo#mappings
```

### Storage Variables

```leo file=../code_snippets/cheatsheet.leo#storage_var
```

### Storage Vectors

```leo file=../code_snippets/cheatsheet.leo#storage_vec
```
...
```leo file=../code_snippets/cheatsheet.leo#standard_operators
```

### Cryptographic

```leo file=../code_snippets/cheatsheet.leo#crypto_operators
```
