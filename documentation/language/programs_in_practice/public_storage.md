...
```leo file=../../code_snippets/public_storage.leo#mapping_decl
```
...
```leo file=../../code_snippets/public_storage.leo#mapping_contains
```

To query a value for a particular `address` in `balance`:

```leo file=../../code_snippets/public_storage.leo#mapping_get
```
...
```leo file=../../code_snippets/public_storage.leo#mapping_get_or_use
```

A program can also query values from another program's mappings:

```leo file=../../code_snippets/public_storage/credits_reader.leo#cross_program_reads
```
...
```leo file=../../code_snippets/public_storage.leo#mapping_set
```

To remove the value set at particular `address` in `balance`:

```leo file=../../code_snippets/public_storage.leo#mapping_remove
```

### Usage

```leo file=../../code_snippets/public_storage.leo#mapping_usage showLineNumbers
```
...
```leo file=../../code_snippets/public_storage.leo#storage_var_decl
```
...
```leo file=../../code_snippets/public_storage.leo#storage_var_unwrap
```
...
```leo file=../../code_snippets/public_storage.leo#storage_var_unwrap_or
```
...
```leo file=../../code_snippets/public_storage.leo#storage_var_set
```

To unset the value at `counter`:

```leo file=../../code_snippets/public_storage.leo#storage_var_unset
```

### Usage

```leo file=../../code_snippets/public_storage.leo#storage_var_usage showLineNumbers
```
...
```leo file=../../code_snippets/public_storage/external_var_decl.leo#file
```

You may query this value from your program using:

```leo file=../../code_snippets/public_storage/external_consumer.leo#ext_var_unwrap
```
...
```leo file=../../code_snippets/public_storage/external_consumer.leo#ext_var_unwrap_or
```
...
```leo file=../../code_snippets/public_storage.leo#storage_vec_decl
```
...
```leo file=../../code_snippets/public_storage.leo#storage_vec_get
```
...
```leo file=../../code_snippets/public_storage.leo#storage_vec_len
```
...
```leo file=../../code_snippets/public_storage.leo#storage_vec_set
```

To push an element onto the end of `id_numbers`:

```leo file=../../code_snippets/public_storage.leo#storage_vec_push
```

To pop and return the last element of `id_numbers`:

```leo file=../../code_snippets/public_storage.leo#storage_vec_pop
```

To remove the element at index `idx`, return it, and replace it with the final element of `id_numbers`:

```leo file=../../code_snippets/public_storage.leo#storage_vec_swap_remove
```

To clear every element in `id_numbers`:

```leo file=../../code_snippets/public_storage.leo#storage_vec_clear
```
...
```leo file=../../code_snippets/public_storage.leo#storage_vec_usage showLineNumbers
```
...
```leo file=../../code_snippets/public_storage/external_vec_decl.leo#file
```

You may query elements or the length of this vector from your program:

```leo file=../../code_snippets/public_storage/external_consumer.leo#ext_vec_reads
```
