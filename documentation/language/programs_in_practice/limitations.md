...
- the maximum size of the compiled program is **1024 KB** by character count. This limit is raised by consensus version: 100 KB (V1), 512 KB (V14), and 1024 KB (V16).
...
- **the maximum transaction size is 1280 KB**, also raised by consensus version: 128 KB (V1), 768 KB (V14), and 1280 KB (V16). If your program exceeds this — for example by requiring large inputs or producing large outputs — consider optimizing the data types in your Leo code.
