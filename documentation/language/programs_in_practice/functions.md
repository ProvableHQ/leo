...
```leo file=../../code_snippets/functions/entry_basic.leo showLineNumbers
```
...
```leo file=../../code_snippets/functions/entry_input.leo#snippet showLineNumbers
```
...
```leo file=../../code_snippets/functions/entry_output.leo#snippet showLineNumbers
```
...
```leo file=../../code_snippets/functions/transfer_inline.leo#file showLineNumbers
```
...
```leo file=../../code_snippets/functions/transfer_final_fn.leo#file showLineNumbers
```
...
```leo file=../../code_snippets/functions/helper_basic.leo#snippet showLineNumbers
```

Helper functions also support **const generics**:

```leo file=../../code_snippets/functions/const_generic.leo showLineNumbers
```
...
```leo file=../../code_snippets/functions/no_inline.leo#snippet
```
