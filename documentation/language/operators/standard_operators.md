...
```leo file=../../code_snippets/operators/standard.leo#abs
```
...
```leo file=../../code_snippets/operators/standard.leo#abs_wrapped
```
...
```leo file=../../code_snippets/operators/standard.leo#add
```
...
```leo file=../../code_snippets/operators/standard.leo#add_wrapped
```
...
```leo file=../../code_snippets/operators/standard.leo#div
```
...
```leo file=../../code_snippets/operators/standard.leo#div_wrapped
```
...
```leo file=../../code_snippets/operators/standard.leo#mod_op
```
...
```leo file=../../code_snippets/operators/standard.leo#mul
```
...
```leo file=../../code_snippets/operators/standard.leo#mul_wrapped
```
...
```leo file=../../code_snippets/operators/standard.leo#neg
```
...
```leo file=../../code_snippets/operators/standard.leo#pow
```
...
```leo file=../../code_snippets/operators/standard.leo#pow_wrapped
```
...
```leo file=../../code_snippets/operators/standard.leo#rem
```
...
```leo file=../../code_snippets/operators/standard.leo#rem_wrapped
```
...
```leo file=../../code_snippets/operators/standard.leo#sub
```
...
```leo file=../../code_snippets/operators/standard.leo#sub_wrapped
```
...
```leo file=../../code_snippets/operators/standard.leo#and_op
```
...
```leo file=../../code_snippets/operators/standard.leo#nand_op
```
...
```leo file=../../code_snippets/operators/standard.leo#nor_op
```
...
```leo file=../../code_snippets/operators/standard.leo#not_op
```
...
```leo file=../../code_snippets/operators/standard.leo#or_op
```
...
```leo file=../../code_snippets/operators/standard.leo#shl
```
...
```leo file=../../code_snippets/operators/standard.leo#shl_wrapped
```
...
```leo file=../../code_snippets/operators/standard.leo#shr
```
...
```leo file=../../code_snippets/operators/standard.leo#shr_wrapped
```
...
```leo file=../../code_snippets/operators/standard.leo#xor_op
```
...
```leo file=../../code_snippets/operators/standard.leo#gt
```
...
```leo file=../../code_snippets/operators/standard.leo#gte
```
...
```leo file=../../code_snippets/operators/standard.leo#eq
```
...
```leo file=../../code_snippets/operators/standard.leo#neq
```
...
```leo file=../../code_snippets/operators/standard.leo#lt
```
...
```leo file=../../code_snippets/operators/standard.leo#lte
```
...
```leo file=../../code_snippets/operators/standard.leo#block_height
```
...
```leo file=../../code_snippets/operators/standard.leo#block_timestamp
```
...
```leo file=../../code_snippets/operators/standard.leo#self_address
```
...
```leo file=../../code_snippets/operators/standard.leo#self_caller
```
...
```leo file=../../code_snippets/operators/standard.leo#self_checksum
```
...
```leo file=../../code_snippets/operators/external_program_info.leo#external_checksum
```
...
```leo file=../../code_snippets/operators/standard.leo#self_edition
```
...
```leo file=../../code_snippets/operators/external_program_info.leo#external_edition
```
...
```leo file=../../code_snippets/operators/standard.leo#self_program_owner
```
...
```leo file=../../code_snippets/operators/external_program_info.leo#external_program_owner
```
...
```leo file=../../code_snippets/operators/standard.leo#self_signer
```
...
```leo file=../../code_snippets/operators/standard.leo#group_gen
```
...
```leo file=../../code_snippets/operators/standard.leo#aleo_generator
```
...
```leo file=../../code_snippets/operators/standard.leo#aleo_generator_powers
```
...
```leo file=../../code_snippets/operators/standard.leo#double
```
...
```leo file=../../code_snippets/operators/standard.leo#inv
```
...
```leo file=../../code_snippets/operators/standard.leo#square
```
...
```leo file=../../code_snippets/operators/standard.leo#square_root
```
...
```leo file=../../code_snippets/operators/standard.leo#to_x_coordinate
```
...
```leo file=../../code_snippets/operators/standard.leo#to_y_coordinate
```
...
```leo file=../../code_snippets/operators/standard.leo#to_bits
```
...
```leo file=../../code_snippets/operators/standard.leo#from_bits
```
...
```leo file=../../code_snippets/operators/standard.leo#assert_op
```
...
```leo file=../../code_snippets/operators/standard.leo#assert_eq
```
...
```leo file=../../code_snippets/operators/standard.leo#assert_neq
```
...
```leo file=../../code_snippets/operators/standard.leo#ternary
```
