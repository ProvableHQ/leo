...
- [Leo Build Command](./../cli/build.md) - CLI reference for building programs
- [Data Types](../language/data_types.md) - Leo type system reference
- [The Finalization Model](./finalization.md) - Understanding the proof and finalization execution contexts
