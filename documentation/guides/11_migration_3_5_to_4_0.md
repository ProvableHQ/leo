...
```leo file=../code_snippets/migration/transitions_to_fn.leo#file
```
...
```leo file=../code_snippets/migration/function_to_fn.leo#file
```
...
```leo file=../code_snippets/migration/inline_to_fn.leo#file
```
...
```leo file=../code_snippets/migration/inline_finalize.leo#file
```
...
```leo file=../code_snippets/migration/async_block.leo#file
```
...
```leo file=../code_snippets/migration/final_fn.leo#file
```
...
```leo file=../code_snippets/migration/await_to_run.leo#file
```
...
```leo file=../code_snippets/migration/module_struct.leo#file
```
...
```leo file=../code_snippets/migration/constructor.leo#file
```
...
```leo file=../code_snippets/migration/cross_program_caller.leo#snippet
```
...
```leo file=../code_snippets/migration/interface_basic.leo#file
```
...
```leo file=../code_snippets/migration/interface_inheritance.leo#file
```
...
```leo file=../code_snippets/migration/inclusive_ranges.leo#snippet
```
