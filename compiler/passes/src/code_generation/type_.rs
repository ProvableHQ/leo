...
impl CodeGeneratingVisitor<'_> {
    pub fn visit_type(input: &Type) -> String {
        match input {
            ...
            Type::Composite(CompositeType { id, .. }) => {
                Self::legalize_struct_name(id.path.last().unwrap().to_string())
            }
            Type::Boolean => {
