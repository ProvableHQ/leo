...
use leo_ast::{Bytecode, CompiledPrograms, Function, Program, ProgramId, Variant};
use leo_span::Symbol;
...
pub struct CodeGeneratingVisitor<'a> {
    ...
    /// A composite here is identified by its program and its path within that program.
    pub composite_mapping: IndexMap<(Symbol, Vec<Symbol>), bool>,
