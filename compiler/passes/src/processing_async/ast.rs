                ...
                match index_opt {
                    Some(index) => {
                        ...
                        vec![(
                            input,
                            TupleAccess {
                                tuple: Path::from(make_identifier(slf, symbol))
                                    .with_absolute_path(Some(vec![make_identifier(slf, symbol).name]))
                                    .into(),
                                index: index.into(),
                                span: Span::default(),
                                id: slf.state.node_builder.next_id(),
                    ...
                    None => match var_type {
                        ...
                        _ => {
                            ...
                            let argument = Path::from(make_identifier(slf, symbol))
                                .with_absolute_path(Some(vec![make_identifier(slf, symbol).name]))
                                .into();
                            vec![(input, argument)]
                        }
