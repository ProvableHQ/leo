...
use leo_ast::{BinaryOperation, Expression, Node as _, NodeID, Type, UnaryOperation};
use leo_span::sym;
        ...
        match expr {
            ...
            Binary(bin) => {
                ...
                let halting_op = match bin.op {
                    ...
                    Add | Mul | Pow => {
                        matches!(self.get(&expr.id()).expect("Types should be assigned."), Type::Integer(..))
                    }
                    _ => false,
                };
            ...
            Unary(un) => {
                ...
                let halting_op = match un.op {
                    ...
                    Negate => {
                        matches!(self.get(&expr.id()).expect("Type should be assigned."), Type::Integer(..))
                    }
                    _ => false,
                };
