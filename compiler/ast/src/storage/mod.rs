...
/*impl Storage {
    pub fn from_snarkvm<N: Network>(storage: &StorageCore<N>) -> Self {
        Self {
            identifier: Identifier::from(storage.name()),
            type_: Type::from_snarkvm(storage.value().plaintext_type(), None),
