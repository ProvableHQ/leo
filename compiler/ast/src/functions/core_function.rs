...
impl CoreFunction {
    ...
    pub fn from_symbols(module: Symbol, function: Symbol) -> Option<Self> {
        Some(match (module, function) {
            ...
            (sym::Keccak256, sym::hash_to_bits)         => Self::Hash(HashVariant::HashKeccak256Native, Type::Array(ArrayType::bit_array(256))),
            (sym::Keccak256, sym::hash_to_bits_raw)     => Self::Hash(HashVariant::HashKeccak256NativeRaw, Type::Array(ArrayType::bit_array(256))),
            ...
            (sym::Keccak384, sym::hash_to_bits)         => Self::Hash(HashVariant::HashKeccak384Native, Type::Array(ArrayType::bit_array(384))),
            (sym::Keccak384, sym::hash_to_bits_raw)     => Self::Hash(HashVariant::HashKeccak384NativeRaw, Type::Array(ArrayType::bit_array(384))),
            ...
            (sym::Keccak512, sym::hash_to_bits)         => Self::Hash(HashVariant::HashKeccak512Native, Type::Array(ArrayType::bit_array(512))),
            (sym::Keccak512, sym::hash_to_bits_raw)     => Self::Hash(HashVariant::HashKeccak512NativeRaw, Type::Array(ArrayType::bit_array(512))),
            ...
            (sym::SHA3_256, sym::hash_to_bits)         => Self::Hash(HashVariant::HashSha3_256Native, Type::Array(ArrayType::bit_array(256))),
            (sym::SHA3_256, sym::hash_to_bits_raw)     => Self::Hash(HashVariant::HashSha3_256NativeRaw, Type::Array(ArrayType::bit_array(256))),
            ...
            (sym::SHA3_384, sym::hash_to_bits)         => Self::Hash(HashVariant::HashSha3_384Native, Type::Array(ArrayType::bit_array(384))),
            (sym::SHA3_384, sym::hash_to_bits_raw)     => Self::Hash(HashVariant::HashSha3_384NativeRaw, Type::Array(ArrayType::bit_array(384))),
            ...
            (sym::SHA3_512, sym::hash_to_bits)         => Self::Hash(HashVariant::HashSha3_512Native, Type::Array(ArrayType::bit_array(512))),
            (sym::SHA3_512, sym::hash_to_bits_raw)     => Self::Hash(HashVariant::HashSha3_512NativeRaw, Type::Array(ArrayType::bit_array(512))),
